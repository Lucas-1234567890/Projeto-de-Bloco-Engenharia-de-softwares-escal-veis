...
export default function App() {
  ...
  return (
    <div style={{ maxWidth: 600, margin: '40px auto', fontFamily: 'Arial' }}>
        ...
        {tasks.map(t => (
          <li key={t.id} style={{
            ...
            <span>
              ...
              <button onClick={() => setTaskSelecionada(t)} style={{ marginRight: 8, padding: '4px 10px', background: '#1F3864', color: '#fff', border: 'none', cursor: 'pointer' }}>
                🕘 Histórico
              </button>
      ...
      {taskSelecionada && (
        <HistoryModal
          taskId={taskSelecionada.id}
          titulo={taskSelecionada.titulo}
